...
###Filter by samples that has passed QC for gene expression
...
##Diversity measures
Obtain_diversity<-function(data,Pancreas.repertoire.diversity,chainType,sample_order){
  sample<-rownames(Pancreas.repertoire.diversity)
  entropy<-NULL
...
Pancreas.repertoire.diversity[,paste0("entropy_20_",chainType)]<-rowMeans(cbind(get(paste0("entropy_1_",chainType)),
...
for (i in 1:5){
  assign(paste0("entropy_",i,"_",chainType),Obtain_diversity(data_merge_pancreas,Pancreas.repertoire.diversity,chainType,0.4))
}
Pancreas.repertoire.diversity[,paste0("entropy_40_",chainType)]<-rowMeans(cbind(get(paste0("entropy_1_",chainType)),
                                                                              get(paste0("entropy_2_",chainType)),
                                                                              get(paste0("entropy_3_",chainType)),
                                                                              get(paste0("entropy_4_",chainType)),
                                                                              get(paste0("entropy_5_",chainType))))
...
for (i in 1:5){
  assign(paste0("entropy_",i,"_",chainType),Obtain_diversity(data_merge_pancreas,Pancreas.repertoire.diversity,chainType,0.6))
}
Pancreas.repertoire.diversity[,paste0("entropy_60_",chainType)]<-rowMeans(cbind(get(paste0("entropy_1_",chainType)),
                                                                                get(paste0("entropy_2_",chainType)),
                                                                                get(paste0("entropy_3_",chainType)),
                                                                                get(paste0("entropy_4_",chainType)),
                                                                                get(paste0("entropy_5_",chainType))))
...
for (i in 1:5){
  assign(paste0("entropy_",i,"_",chainType),Obtain_diversity(data_merge_pancreas,Pancreas.repertoire.diversity,chainType,0.8))
}
Pancreas.repertoire.diversity[,paste0("entropy_80_",chainType)]<-rowMeans(cbind(get(paste0("entropy_1_",chainType)),
                                                                                get(paste0("entropy_2_",chainType)),
                                                                                get(paste0("entropy_3_",chainType)),
                                                                                get(paste0("entropy_4_",chainType)),
                                                                                get(paste0("entropy_5_",chainType))))
