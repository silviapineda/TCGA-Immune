...
FILES=/Users/Pinedasans/TCGA-Immune/Data/Pancreas_Validation/Recon/*.txt
for f in $FILES
do  
   echo $f
...
python2.7 recon_v2.2.py -D -Q 0 1 2 inf -b error_bar_parameters.txt -o /Users/Pinedasans/TCGA-Immune/Data/Pancreas_Validation/Recon/test_D_number_table.txt $variantParameters
