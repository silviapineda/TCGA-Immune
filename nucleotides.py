...
def main():
    ...
    ########################
    print("Start")
    nucleotides_Dataframe = pd.read_csv("~/TCGA-Immune/Data/PAAD/data_clonesInference_aa.txt",sep="\t")
    ...
    ###Result
    result_ClonesInfered.to_csv('~/TCGA-Immune/Data/PAAD/ClonesInfered_PAAD_aa.csv')
    print("End")
