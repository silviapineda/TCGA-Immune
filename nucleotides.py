...
def main():
    ...
    ########################
    print("Start")
    nucleotides_Dataframe = pd.read_csv("~/TCGA-Immune/Data/PAAD_GTEx_ValTumor_ValNormal/data_for_cloneInfered_Ig_PAAD_GTEx_ValTumor_ValNormal.txt",sep="\t")
    ...
    ###Result
    result_ClonesInfered.to_csv('~/TCGA-Immune/Data/PAAD_GTEx_ValTumor_ValNormal/ClonesInfered_Ig_PAAD_GTEx_ValTumor_ValNormal.csv')
    print("End")
